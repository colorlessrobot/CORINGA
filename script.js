...
const relegio = document.getElementById("relogio");
...
//Carrega os items da lista a partir do armazenamento getItensBD limpa o conteúdo da tabela. Setibens é mais para axuliar a função a "encontrar" o necessário
  setItensBD()
...
//Basicamente é o comando que carrega a lista quando a pagina é carregada
function loadItens() {
  itens = getItensBD()
  tbody.innerHTML = ''
